...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 20:10:09 2018
...
def get_filters():
    ...
    while True:
        ...
        while city not in CITY_DATA.keys():
            city = input("We unfortunately do not have this data, yet. "
                         "Please type Chicago, New York, or Washington: ").lower()
            i += 1
            if i == 2:
                print("\nSame issue as before. Here are the available inputs: \n")
                print(cities)
                print()
                city = input("City: ").lower()
                i += 1
        ...
        month = input("Choose a month (January, February, March, April, May, June) "
            "or all to filter: ").lower()
        i = 0
        while month not in months:
            if month == "all":
                break
            month = input(
                "Opps! Looks like you are trying to filter outside of what we "
                "asked. Please filter by January, Febuary, March, April, May, "
                "June or all: ").lower()
            i += 1
            if i == 2:
                print("\nSame issue as before. Here are the available inputs: \n")
        ...
        day = input("Choose a day of the week (Monday through Sunday), or all: ").lower()
        i = 0
        while day not in days:
            if day == "all":
                break
            day = input("Opps! Looks like you are trying to filter outside of what we "
                "Please filter by a valid weekday, or all: ").lower()
            i += 1
            if i == 2:
...
if __name__ == "__main__":
    main()
||||||| parent of cd3b20c... Moved from an extra folder bikeshare_project_nicholasdrake
=======
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 20:10:09 2018
...
if __name__ == "__main__":
    main()
>>>>>>> cd3b20c... Moved from an extra folder bikeshare_project_nicholasdrake
||||||| parent of 9012a3d... fix: Accidentally deleted file, re-added it to master.
=======
# -*- coding: utf-8 -*-
"""
Created on Tue Oct  9 20:10:09 2018
...
if __name__ == "__main__":
    main()
>>>>>>> 9012a3d... fix: Accidentally deleted file, re-added it to master.
